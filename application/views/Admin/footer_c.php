...
<script src="<?php echo base_url() ?>admin_file/admin/plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="<?php echo base_url() ?>admin_file/admin/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<?php echo base_url() ?>admin_file/admin/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
...
<script src="<?php echo base_url() ?>admin_file/admin/plugins/ckeditor/ckeditor.js"></script>
<!-- page script -->
<!-- chosen script start -->
