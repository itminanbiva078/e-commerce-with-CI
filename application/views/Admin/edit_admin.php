      ...
      <div class="row">
        <div class="box">
          <div class="box-body" style="min-height: 73vh">
           <?php echo form_open_multipart(base_url('Admin/update_admin')) ?>
           <table class="table table-bordered" id="example1">
             <tr>
              <td><input type="hidden" name="adminID" value="<?php echo @$edit->adminID ?>"></td>
               <th>Admin Name</th>
             ...
             <tr>
               <th>Username</th>
               <td><input type="text" name="username" value="<?php echo @$edit->username ?>" class="form-control"></td>
                <th>Password</th>
               <td>
                <input type="password" name="password" value="<?php echo @$edit->password ?>" class="form-control">
             </td>
             <th>Status</th>
               <td>
                <input type="text" name="status" value="<?php echo @$edit->status ?>" class="form-control">
             </td>
             </tr>
             <tr>
