      ...
      <div class="row">
        <div class="box">
          <div class="box-body" style="min-height: 73vh">
           <?php echo form_open_multipart(base_url('Admin/update_general_contact')) ?>
           <table class="table table-bordered" id="example1">
             <tr>
              <td><input type="hidden" name="id" value="<?php echo @$edit->id ?>"></td>
               <th>Contact Text</th>
               <td><input type="text" name="contact_text" value="<?php echo @$edit->contact_text ?>" class="form-control" ></td>
               <th>Contact Banner</th>
               <td>
                <img src="<?php echo base_url('uploads/'.$edit->contact_banner) ?>" width="100px" height="100px">
                <input type="file" name="contact_banner" class="form-control">
              </td>
               <th>Map Link</th>
               <td><input type="text" name="map" value="<?php echo @$edit->map ?>" class="form-control" ></td>
             </tr>
             <tr>
