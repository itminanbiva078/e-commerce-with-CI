				...
				<aside class="widget widget-categories">
					...
					<aside class="widget product-tag">
						...
						<ul>
							...
							<li><a href="<?php echo base_url('Front/category_list/'.$k->categoryID); ?>">shirt</a></li>
							<li><a href="<?php echo base_url('Front/category_list/'.$k->categoryID); ?>"> man</a></li>
							<li><a href="<?php echo base_url('Front/category_list/'.$k->categoryID); ?>"> kids shirt</a></li>
						</ul>
					</aside>
					...
					<div class="shop-content">
						...
						<div class="product-img">              
												...
												<div class="product-content">
													<h3><a href="<?php echo base_url('Front/details/'.$key->productID); ?>"><?php echo $key->name; ?></a></h3>
													<div class="price">
									...
									<div class="col-md-12">
										<?php foreach ($cat_list as $key) { ?>
											<div class="single-product">
												...
												<div class="product-content">
													<h3><a href="http://smzint.com/ecom/product/pure-muslin-silk-sharee-from-manikganj/18"></a><?php echo $key->name; ?></h3>
													<div class="price">                   
														<span><?php echo $key->price; ?></span>
														<span class="old"><?php echo $key->previous_price; ?></span>
													</div>
													<p class="justify"><?php echo $key->brief; ?></p>
													<div class="product-action">
														<div class="button-top">
															<a href="javascript:void(0)" onclick="show(18)"><i class="fa fa-search"></i></a>
														</div>
